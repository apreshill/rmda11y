...
#a11y <- read_theme("a11y_v2.theme")

#a11y <- read_theme("a11y_v3.theme")
...
1. `a11y` deep cerulean (`#007BA5`) is not high enough contrast with `#f8f8f8` background color
...
1. Lightness: adjust to about 40 (check)
...
+ feels like need to choose between va / dt / er / al 
...
```{r}
testing <- tibble(
  fg = c("#5842ff", "#7060eb", "#06805e", "#3D9970", "#003366", "#D63519", "#DD2810", "#9a61b2"),
  abbr = c("electric", "blue", "green", "olive", "navy", "new_red", "redd", "zoo")
)

# some candidate color replacements
cand_colors <- tribble(
  ~abbr, ~fg,
  "ocean_green", "#3D9970", 
  "royal_heath", "#9E2F91",
...
ukelele
plot_uv(ukelele) +coord_cartesian(xlim = c(-80, 80), ylim = c(-75, 75))
