...
output:
  distill::distill_article:
    highlight: a11y_v2.theme
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), 'a11y_v2.html')) })
---
